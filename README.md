...
**AI Researcher | Autonomous Driving & Efficient Perception Systems**  
Soongsil University, AI Convergence Department
...
- **Autonomous Driving**: Vehicle perception, control, and decision-making
- **Model Optimization**: Pruning, quantization, knowledge distillation
- **Computer Vision**: Object detection, semantic segmentation, 3D perception
- **Multimodal AI**: Vision-language models, multi-sensor fusion
...
- 📧 **Email**: [rpstss@naver.com](mailto:rpstss@naver.com)
- 🔗 **GitHub**: [@rpstss](https://github.com/rpstss)
